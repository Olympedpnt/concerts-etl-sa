...
def _event_key(e: NormalizedEvent):
    return (
        (e.artist_name or "").strip().lower(),
        (e.venue_name or "").strip().lower(),
        (e.event_datetime_local.date().isoformat() if e.event_datetime_local else "")
    )
...
def consolidate_events(
    ...
    sg_map: Dict[Tuple[str, str, str], NormalizedEvent] = {}
    dc_map: Dict[Tuple[str, str, str], NormalizedEvent] = {}
